...
from src.base.user.web.exeptions.handlers import handle_user_eternal_error, handle_user_exists
...
class UserExceptionHandlersInitializer(Initialize):
    ...
    async def initialize(self):
        ...
        error_handler.register_handler(UserEternalError, handle_user_eternal_error)
