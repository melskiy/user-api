...
from src.base.job_title.web.exeptions.handlers.handle_job_title_eternal_error import handle_job_title_eternal_error
...
class JobTitleExceptionHandlersInitializer(Initialize):
    ...
    async def initialize(self):
        ...
        error_handler.register_handler(JobTitleEternalError, handle_job_title_eternal_error)
